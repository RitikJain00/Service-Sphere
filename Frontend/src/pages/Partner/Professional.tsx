...
const Professional = () => {
  ...
  const navigate = useNavigate();
    ...
    return <div className={`min-h-[100vh] bg-mine-shaft-950 font-['poppins'] overflow-hidden relative`}>
            ...
            <div className={`w-[100vw] h-[100vh] transition-all ease-in-out duration-1000 flex [&>*]:flex-shrink-0  ${location.pathname=='/ProfessionalSignup' ? '-translate-x-1/2 md-mx:-translate-x-full' : 'translate-x-0'} `}> 
            <Signin></Signin>

        <div className={`w-1/2 h-full md-mx:hidden md-mx-min-h-full  transition-all ease-in-out duration-1000  bg-mine-shaft-900 flex flex-col justify-center items-center ${location.pathname=='/ProfessionalSignup' ? 'rounded-r-[200px]' : 'rounded-l-[200px]'}`}>

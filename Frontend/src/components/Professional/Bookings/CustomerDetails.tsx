            ...
            <img src="/Model/user.png" alt="" />
              ...
              <div className="flex flex-col gap-2 mt-2">
                   ...
                   <TextInput
                      ...
                      name='description'
                      disabled
                      value={booking.customer.profile.phone}
                   ...
                   <Textarea
                      ...
                      placeholder="Description"
                      name='description'
                      value={'Address:-     ' + booking.customer.profile.address + '\n' + 'City:-            ' +  booking.customer.profile.city + '\n' + 'PinCode:-    ' +  booking.customer.profile.pincode + '\n' + 'Country:-     ' +   booking.customer.profile.country}

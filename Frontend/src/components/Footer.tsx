  ...
  return <div className=' mt-20 h-80 bg-gradient-to-r from-mine-shaft-900 to-mine-shaft-950 text-mine-shaft-100  rounded-tl-[125px] '>
    ...
    <div className='flex pl-20 pr-5 pt-10  gap-16 mb-4 '>
      ...
      <div className='flex flex-col gap-4 hover:scale-105 transition duration-200'>
        ...
        <div className='hover:text-bright-sun-400'><Link to = '/about'>Terms & Condition</Link></div>
        <div className='hover:text-bright-sun-400'><Link to = '/about'>Privacy Policy</Link></div>
        <div className='hover:text-bright-sun-400'><Link to = '/about'>Refund & Cancellation Policy</Link></div>
      ...
      <div className='flex flex-col gap-4 hover:scale-105 transition duration-200'>
        ...
        <div className='flex flex-col gap-2'>
        <div className='hover:text-bright-sun-400'><Link to = '/about'>Contact Us</Link></div>

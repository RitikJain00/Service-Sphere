          ...
          <div className='mt-8 w-24 h-24  mx-auto'>
            <img src="/Model/user.png" alt="" />
              ...
              <div className="flex flex-col gap-2 mt-2">
                   <label className="text-mine-shaft-100" htmlFor="name">Professional Email <span className='text-red-500'>*</span></label>
                   <TextInput
                    ...
                    <div className="flex flex-col gap-2 mt-2">
                   <label className="text-mine-shaft-100" htmlFor="name">Professional Phone <span className='text-red-500'>*</span></label>
                   <TextInput
                      leftSectionPointerEvents="none"
                    ...
                    <div className="flex flex-col gap-2 mt-2">
                   <label className="text-mine-shaft-100" htmlFor="name">Professional Address <span className='text-red-500'>*</span></label>
                   <Textarea
                      leftSectionPointerEvents="none"
